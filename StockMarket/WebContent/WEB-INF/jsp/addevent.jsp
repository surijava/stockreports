...
<form:form method="post" action="addevent">
		...
		<table style="float: center; margin-left: 350px; margin-top: 16px;"
			...
			<tr>
				<td></td><td></td><td>Event Type:<select name="choice">
						...
						<option value="RBIMeetingStart">RBI Meeting Start</option>
						<option value="RBIMeetingEnd">RBI Meeting End</option>
						<option value="IndiaGDP">India GDP</option>
						<option value="FEDMeetingStart">FED Meeting Start </option>
						<option value="FEDMeetingEnd">FED Meeting End </option>
						<option value="USCPI">US CPI</option>
				</select></td>
			...
			<tr>
				...
				<td></td><td></td>
				<td></td><td></td>
				<td></td><td><input type="submit" class="myButton" value="Submit" /></td>
			</tr>
		</table>
	</fieldset>
</form:form>
