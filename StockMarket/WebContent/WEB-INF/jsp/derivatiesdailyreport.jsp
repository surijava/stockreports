...
<form:form method="post" action="derivatiesdailyreport">
	...
	<fieldset>
		<legend>Derivative Daily Decision Report :</legend>
					...
					<c:forEach var="india" items="${list}">
						...
						<c:if test="${firstrecord == testone}">
							<c:choose>
								...
								<c:when test="${india.changePercentage > 5.0}">
							...
							<div class="tooltip">${india.close}
									...
									-----------------------------------<br/>
									 ...
									 Total Change : ${india.totalChange}<br />
									 Total Change Percentage: ${india.changePercentage}<br />
