package com.stockmarket.pojos;

public class FiiDiiOpenInterestPojo {

	protected String futureindexlong;
	protected String futureindexshort;
	protected String futurestocklong;
	protected String futurestockshort;
	protected String optionindexcalllong;
	protected String optionindexcallshort;
	protected String optionindexputlong;
	protected String optionindexputshort;
	protected String optionstockcalllong;
	protected String optionstockcallshort;
	protected String optionstockputlog;
	protected String optionstockputshort;
	protected String totallongcontracts;
	protected String totalshortcontracts;	
	protected String clienttype;
	protected Double totalLong;
	protected Double totalShort; 
	...
	public String getOptionstockputlog() {
		return optionstockputlog;
	}
	public void setOptionstockputlog(String optionstockputlog) {
		this.optionstockputlog = optionstockputlog;
	}
	...
	public void setTotalShort(Double totalShort) {
